...
export function IconMark(props: SVGProps<SVGSVGElement>) {
  return (
...
export function IconLink(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M9 15 15 9" />
      <path d="M11 6.5 12.5 5A4 4 0 1 1 18 10.5L16.5 12" />
...
export function IconClip(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M21 11.5 12.7 19.8a4.5 4.5 0 0 1-6.4-6.4L14.8 5a3 3 0 0 1 4.2 4.2l-8.3 8.3a1.5 1.5 0 0 1-2.1-2.1l7.6-7.6" />
    </svg>
  );
}
